...
from app.cli.interactive_shell.command_registry.agents.kill import _cmd_agents_kill
from app.cli.interactive_shell.command_registry.agents.trace import _cmd_agents_trace
