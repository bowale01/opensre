...
from tools.github.actions import (
    extract_step_log,
...
def test_list_workflow_runs_happy_path() -> None:
    ...
    with (
        patch("tools.github.actions.resolve_github_mcp_config", return_value=object()),
        patch("tools.github.actions.call_github_mcp_tool", side_effect=_mcp_response),
    ):
